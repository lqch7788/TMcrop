...
import { Users, Plus, Edit, Eye, Trash2, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function SettingsPersonnelStaff() {
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500">组织架构与人员信息管理</p>
          </div>
        </div>
      </div>
