...
import type { RiskAlert, RiskFilters, AlertLevel, AlertType } from '../types';
import { AlertTypeNames } from '../types';
...
const mockAlerts: RiskAlert[] = [
  {
    id: '1',
    alertType: 'overtime',
    alertTypeName: AlertTypeNames.overtime,
    level: 'warning',
    title: '单日加班超时预警',
  ...
  },
  {
    id: '2',
    alertType: 'high_temp',
    alertTypeName: AlertTypeNames.high_temp,
    level: 'danger',
    title: '高温作业预警',
  ...
  {
    id: '3',
    alertType: 'schedule_gap',
    alertTypeName: AlertTypeNames.schedule_gap,
    level: 'critical',
    title: '排班空缺告警',
    content: '4月5日夜间班组无人排班，影响正常生产作业，请尽快安排人员。',
    department: '包装车间',
    createTime: '2026-04-04 14:20:00',
    status: 'pending',
  },
  {
    id: '4',
    alertType: 'contract_expiry',
    alertTypeName: AlertTypeNames.contract_expiry,
    level: 'warning',
    title: '劳动合同即将到期',
  ...
  },
  {
    ...
    alertTypeName: AlertTypeNames.certificate_expiry,
    level: 'danger',
    title: '健康证即将过期',
  ...
  },
  {
    id: '6',
    alertType: 'turnover',
    alertTypeName: AlertTypeNames.turnover,
    level: 'critical',
    title: '月离职率过高预警',
    content: '本月累计离职15人，离职率达到12.5%，超过10%警戒线，请关注人员稳定性。',
    department: '全厂',
    createTime: '2026-04-04 08:00:00',
    status: 'pending',
  },
  {
    id: '7',
  ...
  },
  {
    ...
    status: 'handled',
    handleTime: '2026-04-02 09:00:00',
    handler: '刘经理',
  ...
  },
  {
    ...
    status: 'handled',
    handleTime: '2026-04-04 12:30:00',
    handler: '值班长',
