...
### 前端页面 (完整审核)
- `src/pages/labor/LeavePage.tsx` (1030行)
- `src/pages/labor/OvertimePage.tsx` (903行)
- `src/components/production/ProductionPage.tsx` (671行)
- `src/components/warehouse/WarehouseMaterialsPage.tsx` (1002行)
- `src/components/farm/harvest/HarvestPage.tsx` (768行)

### 种植模块 (完整审核)
- `src/components/farm/planting/PlantingPage.tsx`
- `src/components/farm/planting/modals/EditModal.tsx`
- `src/components/farm/planting/modals/AddModal.tsx`
- `src/components/farm/planting/modals/HarvestModal.tsx`
- `src/components/farm/planting/modals/DetailModal.tsx`
- `src/components/farm/planting/modals/PrintLabelModal.tsx`
- `src/services/apiPlantingService.ts`
- `src/services/plantingService.ts`

### 采收模块 (完整审核)
- `src/components/farm/harvest/HarvestPage.tsx`
- `src/components/farm/harvest/components/*`
- `src/components/farm/harvest/modals/*`
- `src/services/apiHarvestService.ts`
- `src/services/harvestService.ts`
- `server/src/routes/harvest.ts`

### 育苗模块 (完整审核)
- `src/components/farm/seedling/SeedlingPage.tsx`
- `src/components/farm/seedling/modals/*`
- `src/services/apiSeedlingService.ts`
- `src/services/seedlingService.ts`
- `server/src/routes/seedling.ts`

### 订单模块 (完整审核)
- `src/components/farm/order/OrderPage.tsx`
- `src/components/farm/order/components/*`
- `src/components/farm/order/modals/*`
- `src/services/apiCropOrderService.ts`
- `src/services/cropOrderService.ts`
- `server/src/routes/cropOrder.ts`

### 仓储库存模块 (完整审核)
- `src/components/warehouse/WarehouseMaterialsPage.tsx`
- `src/components/warehouse/MaterialInboundTab.tsx`
- `src/components/warehouse/MaterialsTable.tsx`
- `src/services/apiInventoryService.ts`
- `src/services/inventoryService.ts`
- `src/services/warehouseService.ts`
- `server/src/routes/inventory.ts`

### 人力资源模块 (完整审核)
- `src/services/leaveQuotaService.ts`
- `src/services/overtimeCalculationService.ts`
- `src/services/salaryCalculationService.ts`
- `server/src/routes/labor.ts`

### 生产计划模块 (完整审核)
- `src/services/productionPlanService.ts`
- `server/src/routes/productionPlan.ts`

### 农事任务模块 (完整审核)
- `src/hooks/useTasks.ts`
- `src/hooks/useFarmHub.ts`
- `src/services/apiFarmTaskService.ts`
- `server/src/routes/farmTask.ts`
