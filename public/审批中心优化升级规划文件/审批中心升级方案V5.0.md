...
```
审批中心
├── 审批中心主页 (/approvals) - 综合展示所有审批
├── 待办审批 (/pending-approval) - 待处理审批列表
├── 已办审批 (/approved) - 已处理审批列表
├── 我提交的 (/my-approval) - 我发起的审批
│
├── [物料类审批]
│   ├── 领料审批
│   ├── 退料审批
...
- `src/pages/MaterialApproval.tsx` - 物料审批
- `src/pages/ProductionApproval.tsx` - 生产审批
- `src/pages/PendingApproval.tsx` - 待办审批
- `src/pages/Approved.tsx` - 已办审批
- `src/pages/MyApproval.tsx` - 我提交的
...
| V5.0 | 2026-05-04 | 整合`审批中心优化升级方案-opencode.md`，新增详细流程设计示例（5个完整审批流程）、需要确认的问题清单、审批中心菜单规划、相关文件清单，章节扩展至24章 |

---

*文档版本：V5.0*
*参考文档：`审批流程优化-V1.0.md`、`审批中心优化升级方案-opencode.md`*
*生成时间：2026-05-04*
