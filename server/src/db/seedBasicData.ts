...
const defaultDictionaries: DictionarySeed[] = [
  ...
  // 2026-07-16：用户需求增加 — 诱捕（物理诱杀）/ 浸泡（药液浸种）/ 其他（兜底）
  { id: 'AM008', categoryCode: 'application_method', dictCode: 'trap', dictLabel: '诱捕', dictValue: 'trap', color: 'rose', sortOrder: 8, isDefault: 0, status: 'active' },
  { id: 'AM009', categoryCode: 'application_method', dictCode: 'soak', dictLabel: '浸泡', dictValue: 'soak', color: 'indigo', sortOrder: 9, isDefault: 0, status: 'active' },
  { id: 'AM010', categoryCode: 'application_method', dictCode: 'other', dictLabel: '其他', dictValue: 'other', color: 'gray', sortOrder: 10, isDefault: 0, status: 'active' },
  ...
  { id: 'AU002', categoryCode: 'area_unit', dictCode: 'mu', dictLabel: '亩', dictValue: '亩', color: 'green', sortOrder: 2, isDefault: 0, status: 'active' },
  { id: 'AU003', categoryCode: 'area_unit', dictCode: 'shimu', dictLabel: '市亩', dictValue: '市亩', color: 'teal', sortOrder: 3, isDefault: 0, status: 'active' },
  { id: 'AU004', categoryCode: 'area_unit', dictCode: 'hectare', dictLabel: '公顷 (ha)', dictValue: '公顷', color: 'orange', sortOrder: 4, isDefault: 0, status: 'active' },
  { id: 'AU005', categoryCode: 'area_unit', dictCode: 'are', dictLabel: '公亩 (a)', dictValue: '公亩', color: 'cyan', sortOrder: 5, isDefault: 0, status: 'active' },
  { id: 'AU006', categoryCode: 'area_unit', dictCode: 'sqkm', dictLabel: '平方千米 (km²)', dictValue: '平方千米', color: 'purple', sortOrder: 6, isDefault: 0, status: 'active' },
  { id: 'AU007', categoryCode: 'area_unit', dictCode: 'shang', dictLabel: '垧（东北）', dictValue: '垧', color: 'lime', sortOrder: 7, isDefault: 0, status: 'active' },
  { id: 'AU008', categoryCode: 'area_unit', dictCode: 'acre', dictLabel: '英亩 (acre)', dictValue: '英亩', color: 'sky', sortOrder: 8, isDefault: 0, status: 'active' },
  { id: 'AU009', categoryCode: 'area_unit', dictCode: 'qing', dictLabel: '顷（市制）', dictValue: '顷', color: 'amber', sortOrder: 9, isDefault: 0, status: 'active' },
  { id: 'AU010', categoryCode: 'area_unit', dictCode: 'sqzhang', dictLabel: '平方丈', dictValue: '平方丈', color: 'pink', sortOrder: 10, isDefault: 0, status: 'active' },
  { id: 'AU011', categoryCode: 'area_unit', dictCode: 'sqchi', dictLabel: '平方尺', dictValue: '平方尺', color: 'rose', sortOrder: 11, isDefault: 0, status: 'active' },
  { id: 'AU012', categoryCode: 'area_unit', dictCode: 'qing_traditional', dictLabel: '顷（古代）', dictValue: '古代顷', color: 'gray', sortOrder: 12, isDefault: 0, status: 'active' },
  // 通用是否
