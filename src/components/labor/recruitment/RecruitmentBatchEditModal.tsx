...
export function RecruitmentBatchEditModal({
  ...
  return (
    <UnifiedModal isOpen={isOpen} onClose={onClose} title="批量编辑招聘申请" size="xxl" showFooter={false}>
      <div className="flex flex-col">
        ...
        <div className="flex items-center gap-4 mb-3">
          <div className="flex-1">
            <Label className="text-xs font-medium text-gray-600 mb-1">选择招聘申请记录</Label>
            <select
            ...
            <div className="grid grid-cols-4 gap-3 flex-shrink-0">
              ...
              <div className="bg-gray-50 rounded-lg p-2">
                ...
                <NumberInput
                  ...
                  onChange={(val) => handleFieldChange('quantity', val === '' ? 0 : Number(val))}
                  decimals={0}
                />
              </div>
