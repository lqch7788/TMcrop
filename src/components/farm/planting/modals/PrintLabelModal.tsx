          ...
          {template === 'small' ? (
            <div className="flex flex-col items-center">
              ...
              <div className="mt-3 text-center">
                <div className="text-sm font-bold text-gray-900">{record.plantCode}</div>
                <div className="text-xs text-gray-600 mt-1">{record.cropName}</div>
                <div className="text-xs text-gray-500 mt-1">
                  {record.plantingCount.toLocaleString()} 株
                </div>
              </div>
            </div>
          ) : (
            <div className="flex flex-col items-center">
              ...
              <div className="mt-4 text-center">
                <div className="text-lg font-bold text-gray-900">{record.plantCode}</div>
                <div className="text-sm text-gray-600 mt-2">{record.cropName} - {record.cropVariety}</div>
                <div className="text-sm text-gray-600 mt-1">
                  数量：{record.plantingCount.toLocaleString()} 株
                </div>
