    ...
    <div className="bg-[#F2F6FA] rounded-xl shadow-sm border border-gray-100 p-4 mb-6">
      <div className="flex flex-wrap items-end gap-4">
        ...
        <div className="flex-1 grid grid-cols-2 md:grid-cols-5 gap-3">
          {/* 任务ID搜索 */}
          <div>
            <Label className="text-xs text-gray-500 mb-1">任务ID</Label>
            <Input
              type="text"
              value={taskIdSearch}
          ...
          {/* 时间范围筛选 */}
          <div>
            <Label className="text-xs text-gray-500 mb-1">时间范围</Label>
            <Select
              value={timeFilter}
          ...
          {/* 任务区域筛选 */}
          <div>
            <Label className="text-xs text-gray-500 mb-1">任务区域编号</Label>
            <Select
              value={fieldFilter}
          ...
          {/* 执行人筛选 */}
          <div>
            <Label className="text-xs text-gray-500 mb-1">执行人</Label>
            <Select
        ...
        <div className="flex items-center gap-2">
          ...
          {canSmartRecommend && (
            <Button
              ...
              className="bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 text-white shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 hover:from-violet-500 hover:via-purple-500 hover:to-fuchsia-500 transition-all duration-300 animate-pulse-subtle"
            >
          ...
          <div className="flex border border-gray-200 rounded-lg overflow-hidden ml-2">
            <Button
              ...
              className={`${viewMode === 'list' ? 'bg-emerald-500 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
            >
            ...
            <Button
              ...
              className={`${viewMode === 'calendar' ? 'bg-emerald-500 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'}`}
            >
