...
export const tempTasks: TempTask[] = [
  ...
  // 状态3: 进行中 (in_progress) - 除草任务
  {
    id: 'TT003',
    taskCode: 'TT20260418-003',
    title: 'C区杂草清理',
    type: 'other',
    typeName: '除草',
    priority: 'high',
    ...
    assignerName: '管理员',
    dueDate: '2026-04-19',
    description: 'C区杂草生长旺盛，影响作物生长，需尽快清理',
    notes: '进行中，已清理一半区域',
    images: [],
    urgency: 'high',
    tempTaskType: '除草',
  ...
  // 状态5: 已驳回 (rejected) - 被驳回1次
  {
    id: 'TT005',
    taskCode: 'TT20260418-005',
    title: 'E区修剪作业',
    type: 'other',
    typeName: '修剪',
    priority: 'normal',
    ...
    estimatedHours: 3,
    actualHours: 1,
    rejectReason: '修剪不彻底，底部侧枝未清理干净',
    acceptedAt: '2026-04-15T08:00:00.000Z',
    rejectCount: 1,
    createdAt: '2026-04-15T08:00:00.000Z',
    updatedAt: '2026-04-17T18:00:00.000Z',
  },
  // 状态6: 待重新派发 (pending_reassign) - 被驳回2次
  {
    id: 'TT006',
    taskCode: 'TT20260418-006',
    title: 'F区浇水作业',
    type: 'other',
    typeName: '浇水',
    priority: 'high',
