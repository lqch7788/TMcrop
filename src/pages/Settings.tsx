...
import { Settings as SettingsIcon, Leaf, MapPin, Sprout, Package, ScrollText, Users, Target, ChevronRight, ArrowLeft, Building2, Building, Layers, Shield, Bell, GitBranch, Monitor, Warehouse, Calculator, FileText, BookOpen, Settings as SettingsCog, BarChart3 } from 'lucide-react';
...
const settingsSections = [
  ...
  { icon: Sprout, label: '农事活动', path: '/settings/farm-activity', desc: '管理农事活动任务' },
