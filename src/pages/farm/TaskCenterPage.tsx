 ...
 * 工作流程：月度规划 → 每日规划 → 智能派工
 *
 * 2026-08-24 PR7：顶部加 AIPanel 共享入口
 * 2026-08-25 fix：加任务选择下拉框（透传 taskId/taskType/greenhouseId 等上下文给 AIPanel）
 *   → 月度/每日规划 tab 没有"当前任务"概念，必须让用户先选任务才能调 AI-01 等模块
 */
...
export default function TaskCenterPage() {
  ...
  // 2026-08-25 fix：拉取待派工任务列表，让用户在 AIPanel 触发前选择任务上下文
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ★ 2026-08-25 fix：AIPanel 共享入口（月度/每日规划 tab）
          月度/每日规划 tab 没有"当前任务"概念，必须让用户先选任务才能调 AI-01 等模块
          智能派工 tab 自带 SmartDispatchPage（含任务池 + AIPanel），无需此下拉框 */}
