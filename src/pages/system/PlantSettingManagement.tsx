  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="p-2 bg-emerald-100 rounded-lg"><Tractor className="w-6 h-6 text-emerald-600" /></div>
        <div><h1 className="text-xl font-semibold text-gray-900">种植设置</h1><p className="text-sm text-gray-500">种植图标和品种种植参数配置</p></div>
      </div>
