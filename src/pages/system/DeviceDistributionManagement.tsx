  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="p-2 bg-blue-100 rounded-lg"><MonitorCheck className="w-6 h-6 text-blue-600" /></div>
        <div><h1 className="text-xl font-semibold text-gray-900">设备分配</h1><p className="text-sm text-gray-500">IoT设备分配到温室/区域 + 运行参数配置（预留端口）</p></div>
      </div>
