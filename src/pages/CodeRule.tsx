...
import { initialCategories as codeRuleData, type BigCategory, type MidCategory, type SubCategory } from '../data/codeRuleData';

export default function CodeRule() {
  const navigate = useNavigate();
  const [categories, setCategories] = useState<BigCategory[]>(codeRuleData);
