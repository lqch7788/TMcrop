      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-2 py-3 text-left text-sm font-semibold text-gray-700 w-24">大类代码</th>
              <th className="px-2 py-3 text-left text-sm font-semibold text-gray-700 w-56">大类名称</th>
              <th className="px-2 py-3 text-left text-sm font-semibold text-gray-700 w-24">中类代码</th>
              <th className="px-2 py-3 text-left text-sm font-semibold text-gray-700 w-56">中类名称</th>
            </tr>
          </thead>
              ...
              return (
                <>
                  ...
                  {expandedBig.has(big.code) && big.midCategories.map((mid) => {
                    return (
                      <tr key={`mid-${big.code}-${mid.code}`} className="hover:bg-gray-50">
                        ...
                        <td className="px-2 py-2">
                          <div className="flex items-center gap-4">
                            {isEditing ? renderEditCell('mid', big.code, mid.code, mid.name) : <span className="font-medium text-gray-800">{mid.name}</span>}
                            {isEditing && (
                              <button
          ...
          <div className="bg-white rounded-xl p-6 w-96 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 justify-end">
                ...
                <button
                  onClick={() => addMidCategory(showAddMid)}
